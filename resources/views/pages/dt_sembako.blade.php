...
@section('content')
  ...
  <div class="flex gap-4">
    ...
    <div class="basis-1/3 h-fit px-4 py-3 rounded-lg bg-white dark:bg-gray-800">
      ...
      <form id="filter-form" action="/belanja/sembako">
        <div>
          <div>
          ...
          <div>
            ...
            <input type="date" id="tgl-akhir" name="tgl-awal" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
          </div>
          <div>
            <label for="tgl-akhir" class="block mt-3 mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Akhir</label>
            <input type="date" id="tgl-akhir" name="tgl-akhir" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
          </div>
          <div>
      ...
      $('#filter-form').submit(function(e) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('#export-btn').attr('href', '/pdf/sembako?data=' + serializedData);
          }
        });
      });
    })
