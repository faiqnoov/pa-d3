...
@section('content')
  ...
  <div class="flex gap-4">
    <div class="basis-2/3 h-fit px-4 py-3 rounded-lg bg-white dark:bg-gray-800">
      <p class="font-semibold text-gray-800 dark:text-gray-200">Nominal Penjualan Kantin <span id="tglAwal"></span> s.d. <span id="tglAkhir"></span></p>
  ...
  <div class="flex gap-4">
    ...
    <div class="basis-1/3 h-fit px-4 py-3 rounded-lg bg-white dark:bg-gray-800">
      ...
      <form id="filter-form" action="/penjualan/kantin">
        <div>
          <div>
          ...
          <div>
            ...
            <div class="flex items-center">
              ...
              <label for="filter-option-1" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jumlah Penjualan</label>
            </div>
          </div>
      ...
      $('#filter-form').submit(function(e) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('#export-btn').attr('href', '/kantin/pdf?data=' + serializedData);
          }
        });
      });
    })
